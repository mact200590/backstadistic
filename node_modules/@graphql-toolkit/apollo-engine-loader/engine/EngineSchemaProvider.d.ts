...
import { ClientIdentity } from './ApolloEngineClient';
export declare class EngineSchemaProvider {
    private config;
    private clientIdentity?;
    private schema?;
    private client?;
    constructor(config: any, clientIdentity?: ClientIdentity);
    resolveSchema(override: any): Promise<GraphQLSchema>;
}
